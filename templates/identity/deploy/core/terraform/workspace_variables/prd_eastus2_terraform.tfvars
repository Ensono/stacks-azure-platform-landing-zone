...
vnet_subnets = {
  subn-activedirectory-1 = {
    ...
    address_prefixes = ["172.25.4.0/26"]
    nsg_rule_names = [
  ...
  subn-certificateauth-1 = {
    ...
    address_prefixes = ["172.25.4.64/26"]
    nsg_rule_names = [
      "NSRC_Platform_AzureLoadBalancer_to_Any",
      "NSRC_RFC1918Priv_10_0_0_0_8_to_Any",
      "NSRC_RFC1918Priv_172_16_0_0_12_to_Any",
  ...
  subn-entraconnect-1 = {
    ...
    address_prefixes = ["172.25.4.128/26"]
    nsg_rule_names = [
      "NSRC_Platform_AzureLoadBalancer_to_Any",
      "NSRC_RFC1918Priv_10_0_0_0_8_to_Any",
      "NSRC_RFC1918Priv_172_16_0_0_12_to_Any",
  ...
  subn-privateendpoint-1 = {
    ...
    address_prefixes = ["172.25.4.192/26"]
    nsg_rule_names = [
      "NSRC_Platform_AzureLoadBalancer_to_Any",
      "NSRC_RFC1918Priv_10_0_0_0_8_to_Any",
      "NSRC_RFC1918Priv_172_16_0_0_12_to_Any",
...
## Domain Controllers ##
# VM keys are global instance numbers per HLD (01, 02 for East US 2)
# Names will be: A2PW000DC01, A2PW000DC02
vms = {
  "01" = {
    zone     = "1"
