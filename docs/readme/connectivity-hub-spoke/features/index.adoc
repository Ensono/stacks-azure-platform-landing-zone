...
Diagnostics and alerts are automatically enabled when the management module integration provides a Log Analytics workspace ID. See <<alerts>> and <<best-practices>>.
