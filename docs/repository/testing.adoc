...
----
# Run all tests
cd src/<module_name>/deploy/terraform
terraform test

# Run specific test file
terraform test tests/subscription_placement.tftest.hcl
...
Tests are located in `src/<module_name>/deploy/terraform/tests/` and cover:
